...
class DocumentStructure:
    ...
    def __repr__(self) -> str:
        """
        Temporary function just to pretty-print the extracted strucutre of 
        the document, to help during development. Might be removed in the future
        where it's utility might not be needed anymore.
        """
        lines = []
        lines.append("=" * 80)
