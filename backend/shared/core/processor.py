...
from shared.parsers import create_parser, BaseDocumentParser
...
class DocumentProcessor:
    ...
    def __init__(
        self,
        session: Session,
        parser: BaseDocumentParser = None,
        extractor = None
    ):
        """
        ...
        Args:
            ...
            parser: BaseDocumentParser instance (creates new if None)
    ...
    def process_document(
        ...
        try:
            ...
            # Step 1: Parse PDF with document parser
            logging.info("Step 1: Extracting text from PDF...")
            parsed_doc = self.parser.parse(file_content)
            ...
            logging.info(f"Extracted {len(full_text)} characters of text (format: {parsed_doc.format})")
    ...
    def _save_to_database(self, filename: str, client_name: str, source_type: str, extracted_data):
        ...
        # Also, embedding was not the focus of this part of development
