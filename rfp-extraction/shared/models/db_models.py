...
class RFP(Base):
    ...
    # Depending on interpretation, QAHistory might link here via origin_rfp_id
...
class Question(Base):
    ...
    # domain_id has an asterisk in your ERD, likely mandatory or indexed.
...
# --- Database Setup (Azure Context) ---

def init_db():
    engine = create_engine(DATABASE_URL, echo=True)
    
    # IMPORTANT: Ensure the pgvector extension is enabled in your Azure Postgres DB.
    # You usually run this once manually or via migration script:
...
if __name__ == "__main__":
    # Uncomment to run the table creation
    init_db()
    # pass